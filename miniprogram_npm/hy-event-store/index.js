...
__DEFINE__(1673690132061, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1673690132062,"./event-store":1673690132063}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1673690132062, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1673690132063, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1673690132062,"./utils":1673690132064}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1673690132064, function(require, module, exports) {
...
return __REQUIRE__(1673690132061);
})()
